...
locals {
  github-email = "xxxxxxxx"                      # you need to change this line
  github-username = "xxxxxxx"                              # you need to change this line
  github-token = "xxxxxxxxx"      # you need to change this line
  key_pair="xxxxx"            # you need to change this line
  pem_key_address = "xxxxxxxx"              # you need to change this line
}
