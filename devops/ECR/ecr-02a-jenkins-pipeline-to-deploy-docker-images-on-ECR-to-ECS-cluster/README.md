...
```json
{
	...
	"containerDefinitions": [{
		"name": "to-do-app",
		"image": "xxxxxxxxxx.dkr.ecr.us-east-1.amazonaws.com/clarusway/to-do-app:latest",
		"portMappings": [{
			"containerPort": 3000,
			"protocol": "tcp"
		}],
